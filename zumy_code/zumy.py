...
class Zumy:
    def __init__(self, dev='/dev/ttyACM0'):
        ...
        self.photo1 = AnalogIn(self.mbed, p16)
        self.photo2 = AnalogIn(self.mbed, p17)
        self.photo3 = AnalogIn(self.mbed, p18)
        self.photo4 = AnalogIn(self.mbed, p19)
    ...
    def read_photo(self):
        return [self.photo1.read(), self.photo2.read(), self.photo3.read(), self.photo4.read()]
