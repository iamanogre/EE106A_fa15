...
message(FATAL_ERROR "Could not find messages which '/home/cc/ee106a/fa15/class/ee106a-ai/ros_workspaces/project/src/tfservice/srv/tfSrv.srv' depends on. Did you forget to specify generate_messages(DEPENDENCIES ...)?
Cannot locate message [TFMessage]: unknown package [tf2_msgs] on search path [{'sensor_msgs': ['/opt/ros/indigo/share/sensor_msgs/cmake/../msg'], 'geometry_msgs': ['/opt/ros/indigo/share/geometry_msgs/cmake/../msg'], 'std_msgs': ['/opt/ros/indigo/share/std_msgs/cmake/../msg']}]")
message(STATUS "kalman_zumy: 0 messages, 3 services")
...
add_custom_target(_kalman_zumy_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "kalman_zumy" "/home/cc/ee106a/fa15/class/ee106a-ai/ros_workspaces/project/src/tfservice/srv/ImuSrv.srv" "geometry_msgs/Vector3"
)
...
add_custom_target(_kalman_zumy_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "kalman_zumy" "/home/cc/ee106a/fa15/class/ee106a-ai/ros_workspaces/project/src/tfservice/srv/NuSrv.srv" "geometry_msgs/Transform:geometry_msgs/Quaternion:geometry_msgs/Vector3"
)
