...
(cl:defmethod cl:initialize-instance :after ((m <ImuSrv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ImuSrv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tfservice-srv:<ImuSrv-request> is deprecated: use tfservice-srv:ImuSrv-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <ImuSrv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ImuSrv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tfservice-srv:<ImuSrv-response> is deprecated: use tfservice-srv:ImuSrv-response instead.")))

(cl:ensure-generic-function 'linear_acceleration-val :lambda-list '(m))
(cl:defmethod linear_acceleration-val ((m <ImuSrv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tfservice-srv:linear_acceleration-val is deprecated.  Use tfservice-srv:linear_acceleration instead.")
  (linear_acceleration m))

(cl:ensure-generic-function 'angular_velocity-val :lambda-list '(m))
(cl:defmethod angular_velocity-val ((m <ImuSrv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tfservice-srv:angular_velocity-val is deprecated.  Use tfservice-srv:angular_velocity instead.")
  (angular_velocity m))
...
(cl:defmethod linear_acceleration_filtered-val ((m <ImuSrv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tfservice-srv:linear_acceleration_filtered-val is deprecated.  Use tfservice-srv:linear_acceleration_filtered instead.")
...
(cl:defmethod angular_velocity_filtered-val ((m <ImuSrv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tfservice-srv:angular_velocity_filtered-val is deprecated.  Use tfservice-srv:angular_velocity_filtered instead.")
