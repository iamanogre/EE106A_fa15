...
(cl:defmethod cl:initialize-instance :after ((m <NuSrv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NuSrv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tfservice-srv:<NuSrv-request> is deprecated: use tfservice-srv:NuSrv-request instead.")))

(cl:ensure-generic-function 'transform-val :lambda-list '(m))
(cl:defmethod transform-val ((m <NuSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tfservice-srv:transform-val is deprecated.  Use tfservice-srv:transform instead.")
  (transform m))

(cl:ensure-generic-function 'origin_tag-val :lambda-list '(m))
(cl:defmethod origin_tag-val ((m <NuSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tfservice-srv:origin_tag-val is deprecated.  Use tfservice-srv:origin_tag instead.")
  (origin_tag m))
...
(cl:defmethod cl:initialize-instance :after ((m <NuSrv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NuSrv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tfservice-srv:<NuSrv-response> is deprecated: use tfservice-srv:NuSrv-response instead.")))
