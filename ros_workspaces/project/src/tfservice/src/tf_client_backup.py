...
class TF_client:
    def __init__(self, mname):
        ...
        self.u = None
        self.z = Transform() # come back and figure out
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            if (ret.updated == True):
                ...
                #     print("TEST")
                # else: 
                self.twist.angular.z = self.prev_twist.angular.z
    ...
    def timeUpdate(self,u):
        ...
        self.v_lin[0] = self.v_lin[0] + rot.dot(u_lin)[0]*self.dt
        self.v_lin[1] = self.v_lin[1] + rot.dot(u_lin)[1]*self.dt
